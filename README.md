...
Scope. These are PortSwigger's deliberately vulnerable training labs, with officially published solutions. Nothing here is a live vulnerability. Lab objectives are paraphrased — see PortSwigger's Web Security Academy for the originals.
